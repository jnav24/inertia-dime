...
return [
    ...
    */
    'commands' => [
        'Server' => 'vendor/bin/sail up',
        'Frontend' => 'pnpm run dev',
        'Pail' => Command::from("bash -c 'sleep 10; vendor/bin/sail artisan pail --timeout=0'"),
        'Logs' => EnhancedTailCommand::file(storage_path('logs/laravel.log')),
        'Queue' => Command::from("bash -c 'sleep 10; vendor/bin/sail artisan queue:work'"),
    ],
